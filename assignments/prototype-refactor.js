...
class CharacterStats extends GameObject {
    constructor (statsopt) {
        super(statsopt);
        this.healthPoints = statsopt.healthPoints;
    }
    takeDamage() {
        return `${this.name} took damage.`
    }
...
class Humanoid extends CharacterStats{
    constructor (humanopts) {
        super(humanopts);
        this.item = humanopts.item;
        this.weapons = humanopts.weapons;
        this.language = humanopts.language;
    }
    greet(){
